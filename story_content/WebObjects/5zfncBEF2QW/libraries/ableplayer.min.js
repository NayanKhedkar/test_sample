                    ...
                    thisObj.setupTranscript().then(function() {
                            ...
                            thisObj.getMediaTimes().then(function(mediaTimes) {
                                ...
                                if (thisObj.player === 'html5') {
                                    ...
                                    // ## customized added to listen when player setup done
                                    setupDone(thisObj);
                                }
        ...
        if (this.mediaType === 'video') {
            ...
            */
            ...
            prefs.push({
                ...
                'group': 'descriptions',
                'default': 1 // off because it burdens user with restarting after every pause
            });
            prefs.push({
...
(function($) {
    ...
    AblePlayer.prototype.calculateControlLayout = function() {
        ...
        if (this.browserSupportsVolume()) {
            ...
            // customized added mute/unmute functionality
            controlLayout[1].push('volume');
        ...
        for (i = 0; i < numSections; i++) {
            ...
            for (j = 0; j < controls.length; j++) {
                ...
                if (control === 'volume') {
                    ...
                    // added customized code to don't show slider when browser doesn't support volume 
                    if (this.browserSupportsVolume()) {
...
(function($) {
    ...
    window.AccessibleSlider = function(mediaType, div, orientation, length, min, max, bigInterval, label, className, trackingMedia, initialState) {
        ...
        this.bodyDiv.on(
            ...
            function(e) {
                coords = thisObj.pointerEventToXY(e);
                // ####### customized code aaded to disable seekbar
                if (thisObj.seekHead.length && IS_DISABLE_SEEK_BAR) {
                    return;
                }
...
(function($) {
    ...
    AblePlayer.prototype.handleVolume = function(direction) {
        ...
        // added customized condition to only show slider popup if browser support volume change
        if (!this.browserSupportsVolume()) {
            this.handleMute();
            return;
        }
    ...
    AblePlayer.prototype.handleMute = function() {
        ...
        if (this.isMuted()) {
            this.setMute(false);
            //## customized event added to listen mute unmute change
            onMuteUnmute(false);
        } else {
            this.setMute(true);
            //## customized event added to listen mute unmute change
...
(function($) {
    ...
    AblePlayer.prototype.playMedia = function() {
        ...
        if (this.player === 'html5') {
            ...
            // added customize code to handle multiple caption appears on mac/safari
        ...
        if (context === 'playpause' || context == 'init') {
            if (typeof this.$bigPlayButton !== 'undefined' && typeof this.seekBar !== 'undefined') {
                ...
                if (this.paused && !this.seekBar.tracking) {
                    ...
                    // custom code to get transcript width for fullscreen and update play button width
                    if (this.fullscreen) {
        ...
        if (captions.length === 1) {
            ...
            if (this.captionsOn === true) {
                ...
                if (this.usingYouTubeCaptions) {
                    ...
                    //## customized code aaded to listen hide caption event
                    onHideCaption(this);
                }
            } else {
                ...
                if (this.usingYouTubeCaptions) {
                    ...
                    //## customized code aaded to listen show caption event
                    onShowCaption(this);
                }
    ...
    AblePlayer.prototype.handleDescriptionToggle = function() {
        ...
        if (!this.$descDiv.is(':hidden')) {
            //## customized code aaded to listen hide discription event
            this.$descDiv.hide();
            onHideDescription(this);
        } 
        this.refreshingDesc = true;
    ...
    AblePlayer.prototype.handleTranscriptToggle = function() {
        ...
        if (this.$transcriptDiv.is(':visible')) {
            ...
            // ### customize code added to hideshow transcript
            onHideTranscript(this);
            ...
            // ### customize code added listen to show transcript
            onShowTranscript(this);
        ...
        //added custom code to handle player size on transcript hide and show
    ...
    AblePlayer.prototype.resizePlayer = function(width, height) {
        ...
        if (this.fullscreen) { // replace isFullscreen() with a Boolean. see function for explanation
            ...
            if (typeof this.$vidcapContainer !== 'undefined') {
                this.$ableWrapper.css({
                    'width': width - transcriptWidth + 'px',
                    'max-width': ''
                });
                this.$vidcapContainer.css({
                    'height': (height - this.$playerDiv.height() - (this.descOn ? this.$descDiv.height() : 0)) + 'px',
                    'width': width - transcriptWidth
                });
                this.$media.css({
                    'height': (height - this.$playerDiv.height() - (this.descOn ? this.$descDiv.height() : 0)) + 'px',
                    'width': width - transcriptWidth
...
(function($) {
    ...
    AblePlayer.prototype.onMediaComplete = function() {
        //## cutomized event added to listen on media completed 
        mediaCompleted();
    ...
    AblePlayer.prototype.onClickPlayerButton = function(el) {
        ...
        // added customized code to disable player event temporary
        if (isPlayerDisable) {
            return;
        }
        ...
        // added customized code for xAPI
    ...
    AblePlayer.prototype.addHtml5MediaListeners = function() {
        ...
        this.$media
            ...
            .on('volumechange', function() {
                ...
                //## customized event added to listen volume change
...
(function($) {
    ...
    AblePlayer.prototype.startDrag = function(which, $element) {
        ...
        if (this.dragDevice === 'mouse') { // might also be a touchpad
            $('.able-wrapper').on('mousemove touchmove', function(e) {
                if (thisObj.dragging) {
                    // calculate new top left based on current mouse position - offset
                    newX = e.pageX - thisObj.dragOffsetX;
                    newY = e.pageY - thisObj.dragOffsetY;
                    var xBound = newX > -(thisObj.$activeWindow.width() / 2) && newX < thisObj.$activeWindow.width() + 160;
                    var yBound = newY > 0 && newY < (thisObj.$activeWindow.height() / 2 - 60);
                    if (thisObj.fullscreen) {
                        xBound = newX > -(thisObj.$activeWindow.width() / 2) && newX < thisObj.$activeWindow.width() + 160;
                        yBound = newY > 0 && newY < (thisObj.$activeWindow.height() / 2 - 60);
